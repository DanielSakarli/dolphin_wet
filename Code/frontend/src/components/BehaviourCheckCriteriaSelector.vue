	...
	<ion-content>
		...
		<ion-modal :is-open="isOpenManual">
			...
			<ion-content class="ion-padding">
				<div v-if="subcriteria === 'firstSubCriteriaBehaviour'">
					<h1>{{ $t('firstSubCriteriaBehaviour') }}</h1>
					<h3>Score 0</h3>
					<p>{{ $t('score0Behaviour1') }}</p>
					<h3>Score 1</h3>
					<p>{{ $t('score1Behaviour1') }}</p>
					<h3>Score 2</h3>
					<p>{{ $t('score2Behaviour1') }}</p>
				</div>
				<div v-if="subcriteria === 'secondSubCriteriaBehaviour'">
					<h1>{{ $t('secondSubCriteriaBehaviour') }}</h1>
					<h3>Score 0</h3>
					{{ $t('score0Behaviour2') }}
					<h3>Score 2</h3>
					<p>{{ $t('score2Behaviour2') }}</p>
				</div>
				<div v-if="subcriteria === 'thirdSubCriteriaBehaviour'">
					<h1>{{ $t('thirdSubCriteriaBehaviour') }}</h1>
					<h3>Score 0</h3>
					<p>{{ $t('score0Behaviour3') }}</p>
					<h3>Score 2</h3>
					<p>{{ $t('score2Behaviour3') }}</p>
				</div>
				<div v-if="subcriteria === 'fourthSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'fifthSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'sixthSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'seventhSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'eighthSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'ninthSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'tenthSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'eleventhSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'twelfthSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'thirteenthSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'fourteenthSubCriteriaBehaviour'">
				...
				<div v-if="subcriteria === 'fifteenthSubCriteriaBehaviour'">
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('firstSubCriteriaBehaviour')"
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('secondSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('thirdSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('fourthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('fifthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('sixthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('seventhSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('eighthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('ninthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('tenthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('eleventhSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('twelfthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('thirteenthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('fourteenthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
					<ion-checkbox
						v-model="CheckboxArray[13][0]"
						@click="handleClick(13, 0)"
						>Score 0</ion-checkbox
					>
				</ion-item>
				<ion-item>
					<ion-checkbox
						v-model="CheckboxArray[13][2]"
						@click="handleClick(13, 2)"
						>Score 2</ion-checkbox
					>
				</ion-item>
				<CheckComments
		...
		>
			...
			<ion-button
				v-if="criteria"
				fill="outline"
				@click="setOpenManual('fifteenthSubCriteriaBehaviour')"
				>{{ $t('userManual') }}</ion-button
			>
			<ion-list>
				<ion-item>
					<ion-checkbox
						v-model="CheckboxArray[14][0]"
						@click="handleClick(14, 0)"
						>Score 0</ion-checkbox
					>
				</ion-item>
				<ion-item>
					<ion-checkbox
						v-model="CheckboxArray[14][2]"
						@click="handleClick(14, 2)"
						>Score 2</ion-checkbox
					>
				</ion-item>
				<CheckComments
...
export default {
	...
	async mounted() {
		...
		// The fill method resets the bodies now
	...
	methods: {
		...
		async storeData() {
			...
			if (confirmed) {
				...
				for (
					let i = 0;
					i < evaluationBehaviourStore.requestBodiesBehaviour.length;
					i++
				) {
					await axios
						.post(
							this.urlPost,
							evaluationBehaviourStore.requestBodiesBehaviour[i],
		...
		async switchDolphin(newValue: any, calledFromConfirmRefresh = false) {
			...
			if (calledFromConfirmRefresh) {
				let currentIndex;
				console.log('Length of dolphinSelect: ', this.dolphinSelect.length);
				if (!Array.isArray(this.dolphinSelect)) {
					// Find the index of the currently selected dolphin
					const tempDolphinSelect = this.dolphinSelect;
					currentIndex = this.dolphinList.findIndex(
						(dolphin) => dolphin.name === tempDolphinSelect //takes the first value of this.dolphinSelect since there is anyway only one dolphin or no dolphin selected while we are here switching the dolphins
					);
					console.log('Current index in switchDolphin: ', currentIndex);
				} else {
					// Find the indexes of all selected dolphins when multiple are selected
					currentIndex = this.dolphinSelect.map((selectedDolphin) => {
						return this.dolphinList.findIndex(
							(dolphin) => dolphin.name === selectedDolphin
						);
					});
				}
				...
				if (Array.isArray(currentIndex)) {
					// currentIndex is an array, handle the first index case
					if (
						currentIndex[0] !== -1 &&
						currentIndex[0] < this.dolphinList.length - 1
					) {
						// Select the next dolphin in the dolphinList
						newValue = this.dolphinList[currentIndex[0] + 1].name;
					} else {
						newValue = null; // De-select the dolphin
						toast.success(this.$t('principleFinished'), {
							autoClose: 5000,
						});
					}
