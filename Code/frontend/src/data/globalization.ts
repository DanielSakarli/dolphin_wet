export const globalizationList = {
	de: {
		...
		passwordHelperText: 'Passwort einegben',
		...
		enclosureBarrierSafety: 'Umzäunungs- und Begrenzungssicherheit',
		enclosureBarrierSafetyComments:
			'Umzäunungs- und Begrenzungssicherheit Kommentare',
		...
		anticipatoryBehaviour: 'Antizipatorisches Verhalten',
		anticipatoryBehaviourComments: 'Antizipatorisches Verhalten Kommentare',
	...
	en: {
		...
		eyePhotos: 'Upload you eye photos here',
		teethPhotos: 'Upload you teeth photos here',
