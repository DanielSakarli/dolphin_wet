...
async function setResult(req, res, next) {
	try {
		...
		if(storageData) {
			...
			// Check if there are eye_photo_paths to be uploaded
			if(storageData.photo_path.eye_photo_path)
				{
					console.log('Photo path in storageData in good_health.js: ' + storageData.photo_path.eye_photo_path);
			...
			if(storageData.photo_path.teeth_photo_path)
				{
					console.log('Photo path in storageData in good_health.js: ' + storageData.photo_path.teeth_photo_path);
				// Iterate over the arrays in test_result
				
					// Check if the dolphin_name in the array is 'Dolly'
					if (test_result.dolphin_name === storageData.dolphin_name) {
						// Append teeth_photo_path to the array
						test_result.teeth_photo_path = storageData.photo_path.teeth_photo_path.toString();
			...
			if(storageData.photo_path.odontogramm_photo_path)
				{
					console.log('Photo path in storageData in good_health.js: ' + storageData.photo_path.odontogramm_photo_path);
				// Iterate over the arrays in test_result
				
					// Check if the dolphin_name in the array is e.g. 'Dolly'
					if (test_result.dolphin_name === storageData.dolphin_name) {
					// Append teeth_photo_path to the array
					test_result.odontogramm_photo_path = storageData.photo_path.odontogramm_photo_path.toString();
					//fileData = fs.readFileSync(test_result.teeth_photo_path);
					//test_result.image = fileData;
			...
			if(storageData.photo_path.marks_photo_path)
				{
					console.log('Photo path in storageData in good_health.js: ' + storageData.photo_path.marks_photo_path);
				// Iterate over the arrays in test_result
				
					// Check if the dolphin_name in the array is 'Dolly'
					if (test_result.dolphin_name === storageData.dolphin_name) {
					// Append marks_photo_path to the array
					test_result.marks_photo_path = storageData.photo_path.marks_photo_path.toString();
				...
				if(storageData.photo_path.silhouette_photo_path)
					...
					if (test_result.dolphin_name === storageData.dolphin_name) {
						...
						const filePath = './uploads/images/' + path.basename(storageData.photo_path.silhouette_photo_path);
						...
						test_result.silhouette_photo_path = storageData.photo_path.silhouette_photo_path.toString();

						console.log('test result silhouette path: ', test_result.silhouette_photo_path, 'for dolphin: ', test_result.dolphin_name);
					}
					}
			
				if(storageData.video_path)
					{
						console.log('Video path in storageData in good_health.js: ' + storageData.video_path);
					// Iterate over the arrays in test_result
					
						// Check if the dolphin_name in the array is 'Dolly'
						if (test_result.dolphin_name === storageData.dolphin_name) {
						// Append eye_photo_path to the array
						test_result.video_path = storageData.video_path.toString();
						//fileData = fs.readFileSync(test_result.eye_photo_path);
						//test_result.image = fileData;
						//console.log(fileData);
