export const globalizationList = {
	...
	en: {
        ...
        thirdSubcriteriaHousing: 'Possibility to freely move between areas, resting place, enganging environment',
        fourthSubcriteriaHousing: 'Possibility of escaping from conspecifics',
        fifthSubcriteriaHousing: 'Absence of forced loneliness',
        sixthSubcriteriaHousing: 'Adequate water PH',
		met: 'Met',
        notMet: 'Not Met',
