<template>
    <div>
      ...
      <form @submit.prevent="addDolphin">
        ...
        <input v-model="dolphin.year_of_birth" type="number" placeholder="Year of Birth">
        <input v-model="dolphin.place_of_birth" type="text" placeholder="Place of Birth">
...
export default {
    setup() {
        ...
        const addDolphin = async () => {
            ...
            errorMessage.value = '';
            try {
                await axios.post('http://88395-17112.pph-server.de/api/dolphins', dolphin.value);
            } catch(error) {
