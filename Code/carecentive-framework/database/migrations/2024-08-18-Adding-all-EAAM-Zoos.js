...
const cities = ['boudewijn', 'cozumel', 'cancun', 'genova', 'kolmarden', 'lisbon', 'loro', 'antibes', 'benidorm', 'portsaintpere', 'rancho', 'torvaianica', 'albufeira'];
...
exports.up = async function (knex) {
  for (const city of cities) {
	...
	await knex.schema.createTable(`${city}_emotional_state`, function (table) {
        ...
        // good_behavior table
		knex.schema.createTable(`${city}_appropriate_behaviour`, function (table) {
        ...
        // good_housing table
		knex.schema.createTable(`${city}_good_housing`, function (table) {
